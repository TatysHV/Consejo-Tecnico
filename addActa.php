          ...
          <form id="frm_addActa" enctype="multipart/form-data" action="conexiones/upload_files.php" method="POST" class="forma">
            ...
            <table id="OrdenDia">
              ...
              <tr>
                ...
                <td><label class="Lform">Subir PDF del Acta:</label></th>
                <td><input id="actapdf" name="acta[]" type="file" multiple="true" class="file"/><input type="hidden" name="MAX_FILE_SIZE" value="5000000" /> </td>
              </tr>
            </table>
            </br></br>
