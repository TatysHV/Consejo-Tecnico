	...
	<body>
      ...
      <div class="row" style="width: 80%; margin: auto;">
        <div id="comites">
          ...
          <center><legend>Modificar Comisión</legend></center>
          <ul>
         ...
         echo '<input type="hidden" value="'.$ID.'" name="id">
                    <div class="row">
                      ...
                      <div class="form-group col-sm-6">
                        ...
                        <select class="selectpicker" data-width="100%" name="tipo">';
                          if($line["tipo"] == "D"){
                            echo'<option value="D">Dictaminadora</option>
                            <option value="E">Evaluadora</option>';
                          }
                          else{
                            echo'<option value="E">Evaluadora</option>
                            <option value="D">Dictaminadora</option>';
                          }
                        echo'
                        </select>
                      </div>
                    ...
                    <div class="row">
                          <div class="col-sm-6">
                            <button type="button" class="btn btn-success" style="float: right" onclick="editComision()">Guardar cambios</button>
                          </div>
                          <div class="col-sm-6">
