...
/*Registra en la base de datos la nueva acta y sube en archivo a la carpeta de uploads.*/
  ...
  /*+++++++++++++++++++++++++++++++++++++++++
    ...
    $query = mysqli_query($con, "INSERT INTO actas (nombre, tipo_sesion, numero_sesion, fecha_sesion, pdf)
    values ('$nombre', '$tipo',  '$numero', '$fecha', '$fichero')")or die("Error al subir el acta" .mysqli_error($con));
