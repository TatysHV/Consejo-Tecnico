	...
	<body>
        ...
        <div id="form_add_oficio">
          ...
          <?php
            ...
            $query0 = 'SELECT * FROM oficios WHERE id_oficio ='.$ID.'';
              ...
              <form id="frm_edit_oficio" enctype="multipart/form-data" method="POST" class="forma">
                ...
                <div class="row">
                  <div class="col-xs-6">
                    ...
                    <input class="form-control" id="folio_oficio" type="text" name="folio_oficio" placeholder="H.C.T/000/AAAA" value="'.$line0['folio'].'">
                  </div>
                  <div class="col-xs-6">
                    <div class="form-group">
                      <label>Fecha de emisión:</label>
                      <input type="date" class="fsesion" id="fecha_emision" value="'.$line0['fecha_emision'].'" name="fecha_emision" style="width:100%; height:34px; border: 1px solid #CCC;"/>
                    </div>
                  </div>
                </div>
                <div class="row">
                    ...
                    <div id="etiqueta">
                      <div class="form-group">
                        <label>Asunto/etiqueta</label><br>';
                          ...
                          <option value="'.$line0["asunto"].'" selected>'.$line0["asunto"].'</option>
                  ...
                  <div class="col-xs-6">
                    <div class="form-group">
                      ...
                      <select name="dirigido" class="form-control" >';
                        if($line0['dirigidoA']=="Secretaría académica"){
                          echo '
                          <option value="Secretaría académica" selected >Secretaría académica</option>
                          <option value="Secretaría de investigación y posgrado">Secretaría de investigación y posgrado</option>
                          <option value="Secretaría de vinculación">Secretaría de vinculación</option>
                          <option value="Servicios escolares">Servicios escolares</option>
                          <option value="Otro departamento">Otro departamento</option>';
                        }
                        else if($line0['dirigidoA']=="Secretaría de investigación y posgrado"){
                          echo'
                          <option value="Secretaría académica">Secretaría académica</option>
                          <option value="Secretaría de investigación y posgrado" selected >Secretaría de investigación y posgrado</option>
                          <option value="Secretaría de vinculación">Secretaría de vinculación</option>
                          <option value="Servicios escolares">Servicios escolares</option>
                          <option value="Otro departamento">Otro departamento</option>';
                        }
                        else if($line0['dirigidoA']=="Secretaría de vinculación"){
                          echo'
                          <option value="Secretaría académica">Secretaría académica</option>
                          <option value="Secretaría de investigación y posgrado" >Secretaría de investigación y posgrado</option>
                          <option value="Secretaría de vinculación" selected>Secretaría de vinculación</option>
                          <option value="Servicios escolares">Servicios escolares</option>
                          <option value="Otro departamento">Otro departamento</option>';
                        }
                        else if($line0['dirigidoA']=="Servicios escolares"){
                          echo'
                          <option value="Secretaría académica">Secretaría académica</option>
                          <option value="Secretaría de investigación y posgrado" >Secretaría de investigación y posgrado</option>
                          <option value="Secretaría de vinculación">Secretaría de vinculación</option>
                        ...
                        else if($line0['dirigidoA']=="Otro departamento"){
                          echo'
                          <option value="Secretaría académica">Secretaría académica</option>
                          <option value="Secretaría de investigación y posgrado" >Secretaría de investigación y posgrado</option>
                          <option value="Secretaría de vinculación">Secretaría de vinculación</option>
                          <option value="Servicios escolares">Servicios escolares</option>
                          <option value="Otro departamento" selected >Otro departamento</option>';
                        }
                        echo'
                      </select>
                    </div>
                ...
                <div class="row">
                  ...
                  <div class="col-xs-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="nombre_oficio"  name="nombre_oficio" value="'.$line0['nombre'].'">
                    </div>
                  </div>
                  ...
                  <div class="col-xs-2">
                    ...
                    <select class="selectpicker" data-width="100%" id="tipo_of" name="tipo_of">';
                      if($line0['tipo_sesion']=="Ordinaria"){
                        echo '
                  ...
                  <div class="col-xs-2">
                    ...
                    <input type="text" class="form-control" name="numsesion_of" value="'.$line0['numero_sesion'].'"/>
                  </div>
                  ...
                  <div class="col-xs-6">
                    <div class="form-group">
                      ...
                      <select name="estatus_of" class="form-control" >';
                        ...
                        if($line0['estatus']=="seguimiento"){
                          echo'
                          <option value="entregado">Entregado</option>
                          <option value="seguimiento" selected>En seguimiento</option>
                          <option value="cancelado">Cancelado</option>
                          <option value="pendiente">Pendiente</option>
                          <option value="completado">Completado</option>';
                        }
                        if($line0['estatus']=="cancelado"){
                          echo'
                          <option value="entregado">Entregado</option>
                          <option value="seguimiento">En seguimiento</option>
